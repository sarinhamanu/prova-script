...
-- Exercício 2
select p.nome  as projetos , d.nome  as departamento, p.valor_total  as Total_valor
from projetos p 
...
-- Exercício 3
select f.nome  as funcuionarios, avg(fp.horas_trabalhadas) as media 
from funcionarios f 
inner join funcionarios_projetos fp  on f.id_funcionario = fp.id_funcionario 
group by f.nome;

-- Exercício 4
select f.nome as funcionarios ,sum(fp.horas_trabalhadas) as total_horas
from funcionarios f 
inner join funcionarios_projetos fp  on fp.id_funcionario =f.id_funcionario 
group by f.nome
...
-- Exercício 5
select p.nome, p.dt_inicio  as projeto
from  projetos p 
order by dt_inicio 
limit  1
;
...
-- Exercício 12
select p.nome as projeto, f.nome as funcionarios, sum(fp.horas_trabalhadas) as horas
from projetos p 
inner join funcionarios_projetos fp  on p.id_projeto = fp.id_projeto 
...
-- Exercício 13
select  f.nome as funcionario, sum(fp.horas_trabalhadas) total_horas
from funcionarios f 
inner join funcionarios_projetos fp  on fp.id_funcionario = f.id_funcionario 
group  by f.nome  
order  by total_horas desc;
...
-- Exercício 14
select p.nome  as projetos, count(fp.id_funcionario) as total_funcionario
from projetos p 
left join funcionarios_projetos fp  on p.id_projeto = fp.id_projeto 
group  by p.nome ;

-- Exercício 15
select p.nome as projeto,f.nome as funcionarios, sum(fp.horas_trabalhadas ) as valor_pago
from funcionarios f 
inner join funcionarios_projetos fp  on  f.id_funcionario = fp.id_funcionario 
